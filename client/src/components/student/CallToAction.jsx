...
function CallToAction() {
  return (
    ...
    <p className='text-gray-500 sm:text-sm'>Incididunt sint fugiat pariatur cupidatat consectetur sit cillium anim id veniam aliqua proident excepteur commodo do ea.</p>
