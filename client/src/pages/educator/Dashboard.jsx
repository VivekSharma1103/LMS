  ...
  return dashboardData ? (
    <div className='min-h-screen flex flex-col md:p-8 p-4 pt-8 gap-10'>
      ...
      <div className='flex flex-wrap gap-6'>
        <div className='flex items-center gap-3 shadow-2xs border border-blue-500 p-4 w-56 rounded-md'>
          <img src={assets.patients_icon} alt="enrolments" className='w-10 h-10' />
          <div>
              ...
              {dashboardData.enrolledStudentsData.map((item, index) => (
                <tr key={index} className='border-b border-gray-500/20'>
                  ...
                  <td className='md:px-4 px-2 py-3 flex items-center space-x-3'>
                    <img className='w-9 h-9 rounded-full' src={item.student.imageUrl} alt="student" />
